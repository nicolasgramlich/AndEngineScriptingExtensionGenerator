...
public class Util {
	...
	public static File getGenJavaClassSourceFile(final File pGenJavaRoot, final Class<?> pClass, final String pGenJavaClassSuffix) {
		return new File(pGenJavaRoot, Util.getGenJavaClassName(pClass).replace('.', File.separatorChar) + pGenJavaClassSuffix + ".java");
	}
	...
	public static File getGenCppClassHeaderFile(final File pGenCppRoot, Class<?> pClass) {
	...
	public static String getGenJavaClassName(final Class<?> pClass) {
		return pClass.getName().replace("org.andengine", "org.andengine.extension.scripting");
	}

	public static String generateCallbackNativeMethodName(final Method pMethod) {
